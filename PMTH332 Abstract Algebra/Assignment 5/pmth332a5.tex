...
Let $F$ be a finite integral domain and take $x \in F$. As $F$ is a domain,
there are no zero divisors. Therefore $x$ is a unit by Proposition
13.21. That is, $\exists x^{-1} \in F$ where $xx^{-1} = x^{-1}x = 1$.
